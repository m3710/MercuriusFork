...
package com.m3710.mercurius.entity
...
data class Conversation(
        ...
        @SerializedName("last_status") val lastStatus: Status?,  // should never be null, but apparently its possible https://github.com/m3710/MercuriusFork//1038
        val unread: Boolean
)