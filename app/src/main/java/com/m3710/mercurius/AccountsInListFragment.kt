...
import com.m3710.mercurius.viewmodel.AccountsInListViewModel
import com.m3710.mercurius.viewmodel.State
...
class AccountsInListFragment : DialogFragment(), Injectable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NORMAL, R.style.MercuriusDialogFragmentStyle)
