...
import com.m3710.mercurius.adapter.AccountSelectionAdapter;
...
import com.m3710.mercurius.interfaces.AccountSelectionListener;
import com.m3710.mercurius.interfaces.PermissionRequester;
...
public abstract class BaseActivity extends AppCompatActivity implements Injectable {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (theme.equals("black")) {
            setTheme(R.style.MercuriusBlackTheme);
        }
    ...
    protected void attachBaseContext(Context base) {
        super.attachBaseContext(MercuriusApplication.localeManager.setLocale(base));
    }
