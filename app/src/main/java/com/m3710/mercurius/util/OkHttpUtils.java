 ...
 *
 * This file is part of Mercurius.
 *
 * Mercurius is free software: you can redistribute it and/or modify it under the terms of the GNU
 ...
 *
 * You should have received a copy of the GNU Lesser General Public License along with Mercurius. If
...
public class OkHttpUtils {
    ...
    /**
     * Add a custom User-Agent that contains Mercurius & Android Version to all requests
     * Example:
     * User-Agent: Mercurius/1.1.2 Android/5.0.2
     */
    @NonNull
    private static Interceptor getUserAgentInterceptor() {
        return chain -> {
            ...
            Request requestWithUserAgent = originalRequest.newBuilder()
                    .header("User-Agent", "Mercurius/"+ BuildConfig.VERSION_NAME+" Android/"+Build.VERSION.RELEASE)
                    .build();
