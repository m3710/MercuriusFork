...
import com.m3710.mercurius.db.TootDao;
import com.m3710.mercurius.db.TootEntity;
...
public final class SaveTootHelper {
    ...
    private List<String> saveMedia(@NonNull List<String> mediaUris,
        ...
        File directory = context.getExternalFilesDir("Mercurius");
        ...
        for (String mediaUri : mediaUris) {
            ...
            String filename = String.format("Mercurius_Draft_Media_%s.%s", timeStamp, fileExtension);
