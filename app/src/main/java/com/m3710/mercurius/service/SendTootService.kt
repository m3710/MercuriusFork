package com.m3710.mercurius.service
...
import com.m3710.mercurius.util.randomAlphanumericString
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        if (intent.hasExtra(KEY_TOOT)) {
            ...
            val builder = NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .setOngoing(true)
                    .setColor(ContextCompat.getColor(this, R.color.mercurius_blue))
            ...
            override fun onResponse(call: Call<Status>, response: Response<Status>) {
                ...
                if (response.isSuccessful) {
                    ...
                    val builder = NotificationCompat.Builder(this@SendTootService, CHANNEL_ID)
                            ...
                            .setColor(ContextCompat.getColor(this@SendTootService, R.color.mercurius_blue))
