...
import com.m3710.mercurius.appstore.CacheUpdater;
import com.m3710.mercurius.appstore.EventHub;
import com.m3710.mercurius.appstore.MainTabsChangedEvent;
import com.m3710.mercurius.appstore.ProfileEditedEvent;
import com.m3710.mercurius.components.conversation.ConversationsRepository;
import com.m3710.mercurius.db.AccountEntity;
import com.m3710.mercurius.entity.Account;
import com.m3710.mercurius.fragment.SFragment;
import com.m3710.mercurius.interfaces.ActionButtonActivity;
import com.m3710.mercurius.interfaces.ReselectableFragment;
import com.m3710.mercurius.pager.MainPagerAdapter;
import com.m3710.mercurius.util.CustomEmojiHelper;
...
import static com.m3710.mercurius.util.MediaUtilsKt.deleteStaleCachedMedia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (ComposeActivity.canHandleMimeType(intent.getType())) {
                // Sharing to Mercurius from an external app
                if (accountRequested) {
        ...
        deleteStaleCachedMedia(getApplicationContext().getExternalFilesDir("Mercurius"));
    }
