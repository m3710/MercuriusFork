...
import com.m3710.mercurius.util.CustomURLSpan
...
class AboutActivity : BottomSheetActivity(), Injectable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        versionTextView.text = getString(R.string.about_mercurius_version, BuildConfig.VERSION_NAME)

        aboutLicenseInfoTextView.setClickableTextWithoutUnderlines(R.string.about_mercurius_license)
        ...
        mercuriusProfileButton.setOnClickListener {
    ...
    private fun onAccountButtonClick() {
        viewUrl("https://gab.com/@Mercurius")
    }
